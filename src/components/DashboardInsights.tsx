...
const DashboardInsights = () => {
  ...
  return (
    <Card className="w-full h-full bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden max-w-3xl mx-auto">
      ...
      <CardContent className="p-3">
        ...
        {/* Key Metrics Grid */}
        <div className="grid grid-cols-3 gap-1 border-t border-gray-200 mt-2">
          {/* Revenue */}
