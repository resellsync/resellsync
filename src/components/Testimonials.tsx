...
const testimonials = [
  {
    company: "TechResell",
    avatar: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=facearea&w=256&h=256",
  ...
  {
    company: "MobilePro",
    avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=facearea&w=256&h=256",
    name: "Sarah Williams",
  ...
  {
    company: "DeviceHub",
    avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=facearea&w=256&h=256",
    name: "David Chen",
